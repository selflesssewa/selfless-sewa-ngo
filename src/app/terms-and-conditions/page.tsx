  ...
  return (
    <main className="min-h-screen">
      <Container className="mb-21 mt-12">
        <h1 className="mb-4 text-headline-sm tracking-normal">
          Terms & Conditions
        </h1>
        <ul className="flex list-[upper-alpha] flex-col gap-3 ps-4 [&_li]:max-w-prose [&_li]:text-pretty [&_li]:text-title-sm [&_li]:drop-shadow-md">
          <li>
          ...
          <li>
            ...
            <span className="font-semibold">Selfless Sewa NGO</span>, an
            non-profitable organization incorporated under{" "}
            <span className="font-semibold">The Indian Trusts Act, 1882</span>{" "}
          ...
          <li>
            <span className="font-semibold">
              REFUND POLICY - REFUND IS NOT APPLICABLE.
            </span>
          </li>
          <li>
            The use of Platform and/or availing of our Services is subject to
            the following Terms of Use:
            <ul className="mt-2 flex list-[lower-roman] flex-col gap-2 ps-4">
              <li>
              ...
              <li>
                You agree not to use the Platform or Services for any purpose
              ...
              <li>
                ...
                loss of data or loss of other economic interests, whether in
                contract, negligence, tort or otherwise, arising from the use of
                or inability to use the Services, however caused and whether
              ...
              <li>
                These Terms and any disputes claim relating to it, or its
